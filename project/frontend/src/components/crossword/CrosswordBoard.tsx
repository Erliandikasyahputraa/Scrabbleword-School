...
import { ThemeBoardBackground } from '../theme/ThemeBoardBackground';
...
export function CrosswordBoard() {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center @container/board relative">
      <div
        ref={boardRef}
        className={`relative box-content flex justify-center items-center focus:outline-none focus:ring-4 focus:ring-[var(--workspace-ring)] rounded-xl overflow-hidden shadow-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 ${isSubmitted ? 'opacity-80 pointer-events-none' : ''}`}
        style={{ 
          ...
          // 5. Clamp between 32px and 54px for visual ergonomics
